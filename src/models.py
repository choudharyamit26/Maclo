...
class UserInstagramPic(models.Model):
    ...
    insta_pic_1 = models.ImageField(upload_to='media', null=True, blank=True)
    insta_pic_2 = models.ImageField(upload_to='media', null=True, blank=True)
    insta_pic_3 = models.ImageField(upload_to='media', null=True, blank=True)
    insta_pic_4 = models.ImageField(upload_to='media', null=True, blank=True)
    insta_pic_5 = models.ImageField(upload_to='media', null=True, blank=True)
    insta_pic_6 = models.ImageField(upload_to='media', null=True, blank=True)
    insta_pic_7 = models.ImageField(upload_to='media', null=True, blank=True)
    insta_pic_8 = models.ImageField(upload_to='media', null=True, blank=True)
    insta_pic_9 = models.ImageField(upload_to='media', null=True, blank=True)
    insta_pic_10 = models.ImageField(upload_to='media', null=True, blank=True)
